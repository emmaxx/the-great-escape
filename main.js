...
function showResults() {
  ...
  score === 0
    ? (resultsContainer.innerHTML = `Listen, you need to give me SOMETHING to work with, you can't just not escape.`)
    : (resultsContainer.innerHTML = `Congrats, you are a survivor! You just escaped from ${escapedCity}!`);
